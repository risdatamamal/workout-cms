            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Edit Trainer') }}</h5>
                            <span>{{ __('Update data trainer, assign roles & permissions') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0)">{{ __('Edit Trainer') }}</a>
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <h3>{{ __('Edit Trainer') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ url('trainer/update') }}">
                            @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="contract" type="number"
                                                    ...
                                                    name="contract" value="{{ $trainer->contract }}"
