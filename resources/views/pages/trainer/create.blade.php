            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Add Trainer') }}</h5>
                            <span>{{ __('Create new trainer, assign roles & permissions') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="card ">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <h3>{{ __('Add Trainer') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('store-trainer') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
