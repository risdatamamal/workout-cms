        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-md-6">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Edit permission will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_sales</code> {{ __('permission')}}</p>
            ...
            <div class="col-xl-6 col-md-6">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Members performance will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_projects</code> {{ __('permission')}}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
                        <div class="table-responsive">
            ...
            <div class="col-md-12">
                <div class="card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3 ">{{ __('Project task list will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_projects</code> {{ __('permission')}}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card">
                    ...
                    <div class="card-block widget-last-task">
                        ...
                        <hr>
                        <p class="mb-0">{{ __('Add project button will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_projects</code> {{ __('permission')}}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card testimonial-card table-card">
                    ...
                    <div class="card-block">
                        <p class="mb-0 p-3">{{ __('Testimonial will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_projects</code> {{ __('permission')}}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_projects')
            ...
            <div class="col-md-12">
                <div class="card table-card">
                    ...
                    <div class="card-block p-b-0">
                        <p class="mb-0 p-3">{{ __('Sales report will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_sales</code> {{ __('permission')}}</p>
                        <!--start permitted area for manage_sales permission -->
                        @can('manage_sales')
                        <div class="table-responsive">
                    ...
                    <p class="mb-0 p-3">{{ __('View all Sales url will visible only for')}}  <code>Admin</code> {{ __('role and')}} <code>manage_sales</code> {{ __('permission')}}</p>
                    <!--start permitted area for manage_sales permission -->
                    @can('manage_sales')
